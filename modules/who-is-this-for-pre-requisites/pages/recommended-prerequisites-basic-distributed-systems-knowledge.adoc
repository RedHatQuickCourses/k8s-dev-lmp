...
:page-audio-src: recommended-prerequisites-basic-distributed-systems-knowledge.wav
:page-transcript-src: recommended-prerequisites-basic-distributed-systems-knowledge.txt
...
* The official Kubernetes documentation on the https://kubernetes.io/docs/concepts/architecture/[Reference Architecture, window=_blank].