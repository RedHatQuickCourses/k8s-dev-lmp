...
:page-audio-src: idempotent-reconciliation.wav
:page-transcript-src: idempotent-reconciliation.txt
...
* https://kubernetes.io/blog/2022/10/20/advanced-server-side-apply/#get-modify-put-patch-controllers[Advanced Server-Side Apply: Patch vs Apply Controllers, window=_blank]
* https://ahmet.im/blog/controller-pitfalls/[Common Pitfalls in Writing Kubernetes Controllers, window=_blank]
