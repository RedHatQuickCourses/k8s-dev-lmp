...
:page-audio-src: distributed-locking-theory.wav
:page-transcript-src: distributed-locking-theory.txt
:navtitle: Distributed Locking Theory

Distributed locks appear simple but conceal subtle failure modes.
This section explains why locks are harder than they look and what guarantees are actually achievable.
...
* https://martin.kleppmann.com/2016/02/08/how-to-do-distributed-locking.html[How to Do Distributed Locking, window=_blank]
* https://kubernetes.io/docs/concepts/architecture/leases[Leases, window=_blank]
