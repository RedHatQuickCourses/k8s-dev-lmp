= Controller Sharding
:page-audio-src: controller-sharding.wav
:page-transcript-src: controller-sharding.txt
...
The https://github.com/timebertt/kubernetes-controller-sharding[kubernetes-controller-sharding, window=_blank] project implements a label-based sharding mechanism:
...
* https://github.com/timebertt/kubernetes-controller-sharding/blob/main/docs/getting-started.md[Controller Sharding Getting Started, window=_blank]
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.11/html/networking/ingress-sharding[Ingress Sharding in OpenShift, window=_blank]
* https://gist.github.com/swghosh/5fe1dc5a04ce1db48f6bef837b11c0e6[OpenShift Ingress Controller Sharding Case Study Notes, window=_blank]
