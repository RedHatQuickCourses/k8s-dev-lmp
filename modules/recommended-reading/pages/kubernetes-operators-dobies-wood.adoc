...
:page-audio-src: kubernetes-operators-dobies-wood.wav
:page-transcript-src: kubernetes-operators-dobies-wood.txt
...
1.  **Define your API:** Before writing logic, follow the https://github.com/kubernetes/community/blob/main/contributors/devel/sig-architecture/api-conventions.md[Kubernetes API Conventions, window=_blank].
...
*   https://tag-app-delivery.cncf.io/whitepapers/operator/[CNCF Operator Whitepaper, window=_blank]: Provides a comprehensive view of how Operators fit into the broader cloud-native ecosystem.

*   https://book.kubebuilder.io/[The Kubebuilder Book, window=_blank]: Essential documentation for mastering the reconciliation pattern in Go.