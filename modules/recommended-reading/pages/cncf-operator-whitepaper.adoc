...
:page-audio-src: cncf-operator-whitepaper.wav
:page-transcript-src: cncf-operator-whitepaper.txt
...
*   **CNCF Tag App Delivery:** Visit the https://tag-app-delivery.cncf.io/whitepapers/operator/[official CNCF Operator Whitepaper, window=_blank] for the complete architectural specification.
